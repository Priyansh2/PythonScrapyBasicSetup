...
class HttpProxyMiddleware(object):
	## old code. Need to be re-implemented with free-proxy list
	proxies = []
	max_proxies = 100
	source = {'port': 8080,
	'type': 'HTTP',
	#'url': 'https://www.proxydocker.com/search?port=%d&type=%s&anonymity=All&country=All&city=All'
	'url':'https://www.proxydocker.com/en/proxylist/search?type=%s&anonymity=all&port=%d&country=all&city=&state=all&need=all'
	}
	def __init__(self):
		self.query_proxies()
